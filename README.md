# 貓芽伺服器 Wiki（CatBud Wiki）

> 貓芽伺服器（CatBud）的**非官方百科**，收錄特殊附魔、指令、功能、指南、物品與遊戲模式等介紹，持續更新中。
...
- 本 Wiki 為**非官方**製作，與貓芽伺服器營運方無從屬關係。
- 本 Wiki 使用之圖片與資料來源：[貓芽伺服器](https://discord.gg/catbud)、[CatBudMC 的 GitHub](https://github.com/CatBudMC)。

---

## 協助校正

若發現內容錯誤或想建議增修，歡迎在 **Discord** 聯繫 **@icebearowob**。
